...
layout: page
title: NextUp Setup
permalink: /nextup_setup/
parent: NextUp
---

# Setting Up NextUp for Development
...
Download Docker Desktop [here](https://www.docker.com/get-started) then install and run it. If you already have Docker Desktop installed, make sure you are upgraded to the latest version.
...
## 6. Install [Google Cloud SDK](https://cloud.google.com/sdk/gcloud)
